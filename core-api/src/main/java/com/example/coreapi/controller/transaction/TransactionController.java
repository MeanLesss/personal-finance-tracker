...
public class TransactionController {
    ...
    @GetMapping
    public RestApiResponse<List<TransactionView>> findAll(Pagination pagination) {
        return new RestApiResponse<>("200", "Success", transactionService.findAll(pagination), pagination);
    }
